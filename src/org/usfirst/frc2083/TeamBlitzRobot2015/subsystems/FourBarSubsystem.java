...
public class FourBarSubsystem extends Subsystem {
	 CANTalon fourBarMotorController = RobotMap.fourBarMotorController;

    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
    CANTalon linearActuator = RobotMap.fourBarMotorController;
    public FourBarSubsystem(){
    	super("Four Bar");
    }
    public void enableControl() {
    	fourBarMotorController.enableControl();
    }
    
    public void disableControl() {
    	fourBarMotorController.disableControl();
    }
    
    public void setVoltage(double v) {
    	fourBarMotorController.set(v);
    }
    public CANTalon getController() {
    	return fourBarMotorController;
    }
